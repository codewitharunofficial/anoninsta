    ...
    >
      ...
      <div className="relative">
        ...
        <input
          ...
          type="search"
          id="default-search"
          className="block w-full p-4 ps-10 text-sm dark:focus:bg-gray-700 focus:bg-white text-gray-900 border border-gray-300 rounded-lg bg-gray-700 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
        ...
        {!loading ? (
          <button
            type="submit"
            disabled={loading}
            className={`text-white absolute end-2.5 bottom-2.5 ${route ? "bg-green-600" : "bg-blue-600"}
